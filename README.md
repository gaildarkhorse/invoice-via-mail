### [invoice-via-mail.com](https://invoice-via-mail.com/)
...
## Update
I am pleased to inform you that the name of this repository has been changed from Arc Invoice to invoice-via-mail.
...
- This project is [MIT](https://github.com/gailldarkhorse/invoice-via-mail/blob/master/LICENSE.md) licensed.
